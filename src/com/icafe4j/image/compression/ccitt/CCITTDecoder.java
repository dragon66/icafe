...
public class CCITTDecoder implements ImageDecoder {

    protected int empty_bits = 8;
    protected int lineOffset = 0;

    public CCITTDecoder(int scanLineWidth, int rowsPerStrip) {
        this.scanLineWidth = scanLineWidth;
        this.rowsPerStrip = rowsPerStrip;
    }

    public CCITTDecoder(byte[] input, int scanLineWidth, int rowsPerStrip) {
        this.input = input;
        this.scanLineWidth = scanLineWidth;
        this.rowsPerStrip = rowsPerStrip;
