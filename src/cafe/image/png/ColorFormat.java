...
/**
 * Define PNG image color formats
 * 
...
public enum ColorFormat {	
	...
	private ColorFormat(int value, String description)
    {
    	this.value = value;
    ...
    public static ColorFormat fromInt(int value) {
       	ColorFormat colorFormat = intMap.get(value);
    	if (colorFormat == null)
    	   return UNKNOWN;
   		return colorFormat;
    }
    
    private static final Map<Integer, ColorFormat> intMap = new HashMap<Integer, ColorFormat>();
    
    static
    {
      for(ColorFormat color : values()) {
